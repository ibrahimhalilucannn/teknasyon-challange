...
!function(a) {
    function b(b) {
        ...
        if ((c = b.text) && !b.id)
            return c;
        d = b.element.value.toLowerCase(),
        e = "img/flags/4x3/" + d + ".svg";
        var f = a("<span/>", {
            text: c
        });
        return a("<img>", {
    ...
    function f(a, b) {
        return b.flag.length && (a = '<img class="img-flag" src="' + b.flag + '">' + a),
        a
    }
    function g(a, b) {
        return a = parseInt(a.replace(/[.,%]/g, "")),
        b = parseInt(b.replace(/[.,%]/g, "")),
        a < b ? 1 : a > b ? -1 : 0
    }
    function h() {
        var a;
        Cookies.get("shareMessage") || (a = "If you like Elephant, please share it with your friends and followers, this way you will help the elephant grow.",
        toastr.info(a, void 0, {
            progressBar: !0,
            timeOut: 15e3,
            extendedTimeOut: 5e3
        }),
        ...
        b.on("click", function(b) {
            ...
            a(":input").each(function(b) {
                var d = a(this)
                  , e = d.attr("id")
                  , f = d.val();
                d.is("input[type='checkbox']") && (f = d.prop("checked")),
                e && f && (c[e] = f)
            });
            var e = c.title || ""
    ...
    function() {
        var b, c;
        b = a("#demo-cropper"),
        b.on("change", "input", function(b) {
            var d = a(this)
              , e = d.attr("name")
              , f = {};
            c.data("cropper") && (f[e] = d.val(),
            c.cropper("destroy").cropper(f))
        }),
        b.on("click", "[data-method]", function(b) {
            var d = a(this)
              , e = d.data();
            c.data("cropper") && e.method && (c.cropper(e.method, e.option),
            "scaleX" !== e.method && "scaleY" !== e.method || d.data("option", -e.option))
        }),
        c = a("#demo-cropper-img"),
        c.cropper()
    }(),
    function() {
    ...
    function() {
        ...
        if (b.length) {
            ...
            a("button.sidenav-toggler").on("click", d),
            d()
        }
    }(),
    function() {
    ...
    function() {
        ...
        if (b.length) {
            var c = new GMaps({
              ...
              , d = [[37.772, -122.214], [21.291, -157.821], [-18.142, 178.431], [-27.467, 153.027]];
            c.drawPolyline({
                path: d,
                strokeColor: "#ff0000",
                strokeOpacity: 1,
    ...
    function() {
        ...
        if (b.length) {
            var c = new GMaps({
              ...
              , d = [[25.774, -80.19], [18.466, -66.118], [32.321, -64.757], [25.774, -80.19]];
            c.drawPolygon({
                fillColor: "#ff0000",
                fillOpacity: .35,
                paths: d,
            ...
            c.on("click", function(a) {
                ...
                d.travelRoute({
                    ...
                    step: function(a) {
                        ...
                        setTimeout(function() {
                            toastr.info(a.instructions),
                            d.setCenter(a.end_location.lat(), a.end_location.lng()),
                            d.drawPolyline({
                                path: a.path,
                                strokeColor: "#ff0000",
                                strokeOpacity: .6,
    ...
    function() {
        var b, c, d, e, f, g, h, l;
        b = a("#demo-chart-1"),
        b.length && (f = ["Cellphones", "Accessories", "Cameras", "Computers", "Tablets", "Vehicle Electronics", "Video Games", "TV", "Audio", "Surveillance"],
        g = function() {
            return j(1e6, 2e6)
        }
        ,
        ...
        a.each(f, function(a, b) {
            ...
            c.borderColor = d,
            c.backgroundColor = d,
            c.pointBorderColor = d,
            c.pointBackgroundColor = d,
            c.pointBorderWidth = 1,
            c.data = [{
                x: h(),
                y: g(),
                r: l()
        ...
        c = new Chart(b,e),
        d = window.matchMedia("(max-width: 992px)"),
        d.addListener(function(a) {
            var b = a.matches ? "bottom" : "right";
            e.options.legend.position = b,
            c.update()
        }))
    }(),
    function() {
        var b, c, d, e, f, g;
        b = a("#demo-chart-2"),
        b.length && (d = ["January", "February", "March", "April", "May", "June", "July"],
        e = ["Questions", "Incidents", "Problems", "Tasks"],
        f = function() {
            return j(1e3, 2e3)
        }
        ,
        ...
        a.each(e, function(b, e) {
            ...
            l.fill = !1,
            l.label = e,
            l.pointBackgroundColor = j,
            l.pointBorderColor = j,
            l.pointBorderWidth = 1,
            l.pointHoverRadius = i,
            l.pointRadius = i,
            b % 2 == 0 && (l.borderDash = [5, 5]),
            c.data.datasets.push(l)
        }),
        new Chart(b,c))
    }(),
    function() {
                ...
                animation: {
                    onComplete: function() {
                        var a = this.chart
                          , b = a.ctx;
                        b.textAlign = "center",
                        Chart.helpers.each(this.data.datasets.forEach(function(c, d) {
        ...
        a.each(d.data.datasets, function(a, b) {
            ...
            b.borderColor = c,
            b.backgroundColor = c,
            b.pointBorderColor = c,
            b.pointBackgroundColor = c,
            b.pointBorderWidth = 2
        }),
        new Chart(b,d))
    }(),
    function() {
